...
namespace GorillaZilla
{
    ...
    public class RoomManager : MonoBehaviour
    {
        ...
        //GorillaZilla Middle manager between the raw Meta Presence SDK and the game GorillaZilla
        [Header("Settings")]
        ...
        public List<Vector3> GetAvailableSpawnLocations()
        {
            ...
            //Create a Grid of 50 by 50 cells
            int end = 25;
            int start = -25;
            
            //For every cell, check if I can spawn a building
